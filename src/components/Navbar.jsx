...
function Navbar() {
  ...
  return (
    <div className='flex w-full justify-between items-center h-20 md:px-4 absolute z-10 text-white'>
      <div >
      ...
      <div onClick={handleNav} className={hamButton ? 'absolute text-black top-0 w-full bg-gray-100/90 px-4 py-7 flex flex-col' : 'absolute left-[-100%]'}>
      <ul>
        <h1>BEACHES</h1>
